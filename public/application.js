...
var config = {
  apiOrigins: {
    production: ' https://morning-stream-87669.herokuapp.com',
...
var createForum = function createForum(data) {
  return $.ajax({
...
var getForums = function getForums() {
  token = '';
  if (store.user) {
...
var getForum = function getForum(data) {
...
var getOwnedForums = function getOwnedForums(data) {
  token = '';
  if (store.user) {
    token = store.user.token;
  }
...
var deleteForum = function deleteForum(data) {
  // if (data.forum) {
  //   id = data.forum.id
  // } else {
  //   id = data
...
var updateForum = function updateForum(data) {
...
var commentApi = __webpack_require__(11);

var userIsCommenter = __webpack_require__(25);
var userNotCommenter = __webpack_require__(42);

var forumInfoTemplate = __webpack_require__(43);
var showOneForumTemplate = __webpack_require__(13);
var forumInfoTemplateWithButtons = __webpack_require__(14);
var forumInfoData = void 0;
var identifyForum = void 0;
var currentUser = void 0;
var forumId = void 0;

var createForumSuccess = function createForumSuccess(data) {
  ...
  api.getForums().then(showForums);
};

var createForumFailure = function createForumFailure(error) {
  store.error = error;
  $('#create-forum-modal').modal('hide');
...
var getForumsSuccess = function getForumsSuccess(data) {
...
var getForumsFailure = function getForumsFailure(error) {
  store.error = error;
...
var getForum = function getForum(event) {
  ...
  api.getForum(forumId).then(function (response) {
...
var forumData = void 0;
var commentTemplate = void 0;
var notCommenterTemplate = void 0;
var isCommenterTemplate = void 0;

var getForumSuccess = function getForumSuccess(data) {
  var ownerOfViewedBlog = data.forum._owner;
  currentUser = store.user.id;

  var commentsArray = data.forum.comments;
  console.log('commentsArray is', commentsArray);

  var checkIfUserIsCommenter = function checkIfUserIsCommenter(array) {
    $('#comments-div').empty();
    array.sort(compare);
  ...
  $('#message').removeClass('alert-danger').addClass('alert-success').show();
  $('#message').delay(2000).slideToggle();
  $('#content').html(forumData).css('opacity', .25).animate({
    opacity: 1
  }, 1000);

  $('#forum-update-open-modal').on('click', function () {
  ...
  $('.show-all-forums-button').on('click', function () {
    api.getForums().then(showForums);
  });
...
var onUpdateForum = function onUpdateForum(event) {
  event.preventDefault();
  ...
  api.updateForum(data).then(updateForumSuccess).then(function () {
    return api.getForum(forumId);
  })
  // .then(getForumSuccessAfterUpdate)
  .then(getForumSuccess).catch(updateForumFailure);
};

var getForumFailure = function getForumFailure() {
  // store.error = error
...
var updateForumSuccess = function updateForumSuccess() {
  // event.preventDefault()
  $('.update-forum-modal').modal('hide');
...
var updateForumFailure = function updateForumFailure() {
  // console.log(error)
  $('.update-forum-modal').modal('hide');
...
var deleteForumSuccess = function deleteForumSuccess(data) {
...
var deleteForumFailure = function deleteForumFailure() {
  // console.log(error)
  $('#confirmDeleteForumModal').modal('hide');
...
var showForums = function showForums(data) {
  ...
  $('form').find('input:not([type="submit"])').val('');
  $('#content').html(forumInfoData).css('opacity', .25).animate({
    // left: '+=50',
    opacity: 1
  }, 1000);
  $('#message').text('forums loaded');
...
var deleteCommentVariable = void 0;
var deleteComment = function deleteComment(event) {
  ...
  api.deleteComment(deleteCommentVariable).then(function () {
    return api.getForum(forumId);
...
module.exports = {
  createForumSuccess: createForumSuccess,
  createForumFailure: createForumFailure,
  getForumsSuccess: getForumsSuccess,
  getForumsFailure: getForumsFailure,
  getForumSuccess: getForumSuccess,
  getForumFailure: getForumFailure,
  updateForumSuccess: updateForumSuccess,
  updateForumFailure: updateForumFailure,
  // identifyForumToUpdate,
  deleteForumSuccess: deleteForumSuccess,
  deleteForumFailure: deleteForumFailure,
...
var getOwnedComments = function getOwnedComments(data) {
  token = '';
  if (store.user) {
    token = store.user.token;
  }
...
module.exports = {
  ...
  getOwnedComments: getOwnedComments,
  deleteComment: deleteComment
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"forumborder\">\n  <h2 class=\"forum-header\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.forum : depth0)) != null ? stack1.body : stack1), depth0))
    + "</h2>\n  <div class=\"resource-body\">posted by: "
    + alias2(((helper = (helper = helpers.user || (depth0 != null ? depth0.user : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"user","hash":{},"data":data}) : helper)))
    + "</div>\n\n\n\n  <form class=\"comment-submit\">\n    <input name=\"forum[_id]\" type=\"hidden\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.forum : depth0)) != null ? stack1._id : stack1), depth0))
    + "\">\n    <textarea class=\"form-control\" name=\"comment[body]\" placeholder=\"comment\" rows=\"3\" required></textarea>\n    <button type=\"submit\" class=\"btn btn-dark-in\">comment</button>\n  </form>\n</div>\n<button type=\"button\" class=\"btn btn-dark-in get-button show-all-forums-button\">back to forums</button>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"forumborder\">\n  <div class=\"forum-message\">you opened this forum</div>\n  <h2 class=\"forum-header\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.forum : depth0)) != null ? stack1.body : stack1), depth0))
    + "</h2>\n  <div class=\"resource-body\">posted by: "
    + alias2(((helper = (helper = helpers.user || (depth0 != null ? depth0.user : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"user","hash":{},"data":data}) : helper)))
    + "\n    <button class=\"btn btn-sm btn-dark-in forum-update-open-modal\" data-target=\".update-forum-modal\" data-toggle=\"modal\">edit</button>\n  </div>\n\n\n\n  <form class=\"comment-submit\">\n    <input name=\"forum[_id]\" type=\"hidden\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.forum : depth0)) != null ? stack1._id : stack1), depth0))
    + "\">\n    <textarea class=\"form-control\" name=\"comment[body]\" placeholder=\"comment\" rows=\"3\" required></textarea>\n    <button type=\"submit\" class=\"btn btn-dark-in\">comment</button>\n  </form>\n</div>\n\n\n\n\n<button type=\"button\" class=\"btn btn-dark-in get-button show-all-forums-button\">back to forums</button>\n";
},"useData":true});
...
var comment = function comment(event) {
  ...
  api.createComment(data).then(ui.commentSuccess);
};

var getOwnedComments = function getOwnedComments(forumId) {
  console.log('forumId in getOwnedComments is', forumId);
  api.getOwnedComments(forumId).then(ui.getOwnedComments);
};
...
var identifyCommentToRemove = function identifyCommentToRemove(event) {
  event.preventDefault();
  // currentEvent = event
...
var removeComment = function removeComment(event) {
  api.deleteComment(deletionId).then(webpagesUI.deleteWebpageSuccess).then(viewMain.goBackToMain).catch(webpagesUI.deleteWebpageFailure);
...
var config = __webpack_require__(5);
var userEvents = __webpack_require__(21);
var forumEvents = __webpack_require__(23);
var commentEvents = __webpack_require__(15);
var forumUi = __webpack_require__(10);
...
var store = __webpack_require__(2);
var forumApi = __webpack_require__(7);
...
var onViewUserInfo = function onViewUserInfo(event) {
  event.preventDefault();
  console.log('onViewUserInfo is running');
  var data = getFormFields(event.target);
  store.viewed_user = data.users;
  api.getUser(data.users.user_id).then(ui.viewOrgInfo).then(function () {
    return forumApi.getOwnedForums(data.users.user_id);
  }).then(ui.showForums).catch(console.error);
};
...
var onCreateForum = function onCreateForum(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createForum(data).then(ui.createForumSuccess).catch(ui.createcreateForumFailure);
};

var onGetAllForums = function onGetAllForums(event) {
  event.preventDefault();
  console.log('onGetAllForums was triggered');
  api.getForums()
  // .then(ui.getForumsSuccess)
  .then(ui.showForums).catch(ui.getForumsFailure);
};

var onGetForum = function onGetForum(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var forum = data.forum;
  // console.log(event)
  api.getForum(forum.id).then(ui.getForumSuccess).catch(ui.getForumFailure);
};
...
var onDeleteForum = function onDeleteForum(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var forum = data.forum;
  api.deleteForum(forum.id).then(ui.deleteForumSuccess).catch(ui.deleteForumFailure);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"comment-body comment-border\">\n  <h3 class=\"resource-body\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1.body : stack1), depth0))
    + "</h3>\n  <div class=\"resource-body\">commented by: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1._owner : stack1), depth0))
    + "\n\n<h1></h1>\n    <form value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1._id : stack1), depth0))
    + "\" class=\"delete-comment-simple\">\n      <input class=\"form-control\" name=\"comment[_id]\" type=\"hidden\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1._id : stack1), depth0))
    + "\">\n      <button value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1._id : stack1), depth0))
    + "\" type=\"submit\" class=\"btn btn-sm btn-dark-in\">\n      delete\n      </button>\n    </form>\n\n  </div>\n</div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div data-id=\""
    ...
    + "</p>\n      <button type=\"button\" class=\"btn btn-dark-in show-one-forum-button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">go</button>\n    </div>\n  </div>\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.forums : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.program(3, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
...
var commentsContentTemplate = __webpack_require__(45);

var commentSuccess = function commentSuccess(data) {
  console.log('data.comment._forum in commentSuccess is', data.comment._forum);
  getForumSuccess(data.comment._forum);
};

var getOwnedComments = function getOwnedComments(data) {
  var commentsContent = commentsContentTemplate({
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"resource-body\">"
    + container.escapeExpression(container.lambda(((stack1 = blockParams[0][0]) != null ? stack1.body : stack1), depth0))
    + "</div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.comments : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
